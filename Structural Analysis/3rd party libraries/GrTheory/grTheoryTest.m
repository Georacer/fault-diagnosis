...
% ntest=26; // GZP - Commenting this out for a more generic file
disp('Enter a test id to run it (1-28)');
disp('Enter 0 to run all tests');
ntest = input('Enter your selection: ');
target = ntest;

if (ntest==0) % Start the countup sequence
    ntest = 1;
    target = 28;
end
