...
%               Only used if shortnames is false
%
...
%  http://opensource.org/licenses/MIT)
  ...
  if isempty(opts.TeXNamesE)
    eNames = model.e;
  else
    eNames = opts.TeXNamesE;
  end
  if isempty(opts.TeXNamesX)
    xNames = model.x;
  else
    xNames = opts.TeXNamesX;
  end
  if isempty(opts.TeXNamesF)
    fNames = model.f;
  else
    fNames = opts.TeXNamesF;
  end
