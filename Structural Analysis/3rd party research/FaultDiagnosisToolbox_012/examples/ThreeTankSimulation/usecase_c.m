...
% This version utilizes C-compiled residual generators. For the Matlab
% version of this script, see usecase.m
...
model.SeqResGen( Gamma1, redeq1,'ResGen1cb', 'implementation', 'discrete', 'language', 'C', 'batch', true );
...
model.SeqResGen( Gamma2, redeq2,'ResGen2cb', 'implementation', 'discrete','language','C', 'batch', true );
...
model.SeqResGen( Gamma3, redeq3,'ResGen3cb', 'implementation', 'discrete','language','C', 'batch', true );

% Observer based residual generator based on the same equations as Resgen1
% (only available as Matlab code)
eqr4 = mso2;
...
r3 = zeros(length(sim),N); % FSM: 1,4,5
