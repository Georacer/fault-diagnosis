    ...
    methods
        function this = g014g()
            ...
            dyn = [dyn;...
                ...
                {'T_y T_atot_y T_ttot_y sub dynamics expr -T_y+T_atot_y+T_ttot_y'};...
            ...
            dyn = [dyn;...
                ...
                {'F_g_z phi theta m g sub gravity expr -F_g_z+cos(phi)*cos(theta)*m*g'};...
                ];
...
%                 {'fault V_mot V_bat I_mot ni delta_t sub motor'};...
            ...
            mod = [mod;...
                ...
                {'h ni T_0 ni P ni P_0 h_0 sub athmosphere expr -h+T_0/L_0*(pow(P/P_0,g_0*M_0/R_star/L_0)-1)+h_0'};... % Barometric altitude calcuation
