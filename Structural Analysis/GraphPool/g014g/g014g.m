classdef g014g < model
    ...
    methods
        function this = g014g()
            ...
            % Mass Distribution
            kin = [kin;...
                {'m m_nom m_i sub mass'};...
                {'p_cm ni m ni p_mi ni m_i sub mass'};...
                {'J J_nom ni p_mi ni m_i ni m_nom sub mass'};...
                {'Ji ni J sub mass'};...
                ];
            ...
            dyn = [dyn;...
                ...
                {'fault F_D ni q_bar C_D sub aerodynamics'};...
                {'fault F_Y ni q_bar C_Y sub aerodynamics'};...
                {'fault F_L ni q_bar C_L sub aerodynamics'};...
                {'fault C_D ni V_a ni alpha ni q ni delta_e sub aerodynamics'};...
                {'fault C_Y ni V_a ni beta ni p ni r ni delta_a ni delta_r sub aerodynamics'};...
                {'fault C_L ni V_a ni alpha ni ni q ni delta_e sub aerodynamics'};...
                {'fault T_a_x ni q_bar C_l sub aerodynamics'};...
                {'fault T_a_y ni q_bar C_m sub aerodynamics'};...
                {'fault T_a_z ni q_bar C_n sub aerodynamics'};...
                {'fault C_l ni V_a ni beta ni p ni r ni delta_a ni delta_r sub aerodynamics'};...
                {'fault C_m ni V_a ni alpha ni q ni delta_e sub aerodynamics'};...
                {'fault C_n ni V_a ni beta ni p ni r ni delta_a ni delta_r sub aerodynamics'};...
                ];
            
            % Propeller
            dyn = [dyn;...
                {'fault F_t_x C_t ni rho ni n_prop sub propeller'};... % Using propeller model
                {'fault F_t_y sub propeller'};...
                {'fault F_t_z sub propeller'};...
                {'T_t_x P_prop ni w_prop sub propeller'};...
                {'fault T_t_y sub propeller'};...
                {'fault T_t_z sub propeller'};...
            ...
            % Motor
            dyn = [dyn;...
                {'fault dot_n_prop P_mot P_prop ni n_prop sub motor'};...
            ...
            msr = [msr;...
                ...
                {'fault msr T_0_m T_0 sub initializations'};... % Initialization temperature
                {'fault msr z_0_m z_0 sub initializations'};... % Initialization altitude
                ...
                {'fault m_nom sub constants'};... % Known nominal mass
                {'fault m_i sub constants'};... % merr = 0;
                {'fault p_mi sub constants'};... % no error mass
                {'fault p_prop sub constants'};...
                {'fault p_cl sub constants'};...
                {'fault J_nom sub constants'};... known inertia component
                {'g msr g_0 sub constants'};... % Taking static gravity for now
                ];
