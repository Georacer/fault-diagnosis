    ...
    methods
        function this = g005()
            ...
            msr = [...
                ...
                {'fault p msr p_m expr -p+p_m'};...
                {'fault q msr q_m expr -q+q_m'};...
                {'fault r msr r_m expr -r+r_m'};...
                {'fault Psi msr Psi_m expr -Psi+Psi_m'};...
                {'fault Theta msr Theta_m expr -Theta+Theta_m'};...
                {'fault Phi msr Phi_m expr -Phi+Phi_m'};...
