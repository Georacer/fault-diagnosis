classdef g014d < model
    
    methods
        function this = g014d()
            this.name = 'g014d';
            this.description = 'Fixed-wing UAV model, revized, according to uav-modeling, with no extra \dot{x} terms. Used in paper 2';
            ...
            kin = [kin;...
                {'m m_nom m_i'};...
                {'p_cm_x ni m ni p_mi_x ni m_i'};...
                {'p_cm_y ni m ni p_mi_y ni m_i'};...
                {'p_cm_z ni m ni p_mi_z ni m_i'};...
                ...
                {'Ji_0 ni J_4 ni J_8 ni J_5 ni J_7 ni detJ'};... 
                {'Ji_1 ni J_2 ni J_7 ni J_1 ni J_8 ni detJ'};... 
                {'Ji_2 ni J_1 ni J_5 ni J_2 ni J_4 ni detJ'};... 
                {'Ji_3 ni J_5 ni J_6 ni J_3 ni J_8 ni detJ'};... 
                {'Ji_4 ni J_0 ni J_8 ni J_2 ni J_6 ni detJ'};... 
                {'Ji_5 ni J_2 ni J_3 ni J_0 ni J_5 ni detJ'};... 
                {'Ji_6 ni J_3 ni J_7 ni J_4 ni J_6 ni detJ'};... 
                {'Ji_7 ni J_1 ni J_6 ni J_0 ni J_7 ni detJ'};... 
                {'Ji_8 ni J_0 ni J_4 ni J_1 ni J_3 ni detJ'};... 
                ];
            ...
            dyn = [dyn;...
                ...
                {'dy_CL p_cm_y p_cl_y'};...
                {'dz_CL p_cm_z p_cl_z'};...
                {'T_atot_x T_a_x ni dy_CL ni dz_CL ni F_a_y ni F_a_z'};... 
                {'T_atot_y T_a_y ni dx_CL ni dz_CL ni F_a_x ni F_a_z'};...
                {'T_atot_z T_a_z ni dx_CL ni dy_CL ni F_a_x ni F_a_y'};...
                {'q_bar rho V_a'};...
            ...
            dyn = [dyn;...
                ...
                {'fault T_t_y'};...
                {'fault T_t_z'};...
                {'dx_prop p_cm_x p_prop_x'};...
                {'dy_prop p_cm_y p_prop_y'};...
                {'dz_prop p_cm_z p_prop_z'};...
                {'T_ttot_x T_t_x ni dy_prop ni dz_prop ni F_t_x ni F_t_z'};...
                {'T_ttot_y T_t_y ni dx_prop ni dz_prop ni F_t_x ni F_t_z'};...
                {'T_ttot_z T_t_z ni dx_prop ni dy_prop ni F_t_x ni F_t_y'};...
                {'n_prop w_prop'};...
                {'Jar V_a n_prop'};...
                {'fault C_t ni Jar'};...
            ...
            msr = [msr;...
                ...
                {'fault m_i'};... % merr = 0;
                {'fault p_mi_x'};... % no error mass
                {'fault p_mi_y'};... % no error mass
                {'fault p_mi_z'};... % no error mass
                {'fault p_prop_x'};...
                {'fault p_prop_y'};...
                {'fault p_prop_z'};...
                {'fault p_cl_x'};...
                {'fault p_cl_y'};...
                {'fault p_cl_z'};...
                {'fault J_nom_0'};... known inertia component
