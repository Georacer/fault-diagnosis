    ...
    methods
        function this = g041()
            ...
            kin = [...
                ...
                {'dot_pe ni u ni v ni w ni Phi ni Theta ni Psi expr -dot_pe+(cos(Theta)*sin(Psi))*u+(sin(Phi)*sin(Theta)*sin(Psi)+cos(Phi)*cos(Psi))*v+(cos(Phi)*sin(Theta)*sin(Psi)-sin(Phi)*cos(Psi))*w'};...
            ...
            dyn = [...
                ...
                {'Fgx par g par m Theta expr -Fgx-m*g*sin(Theta)'};...
                {'Fgy par g par m ni Theta Phi expr -Fgy+m*g*cos(Theta)*sin(Phi)'};...
                {'Fgz par g par m Theta Phi expr -Fgz+m*g*cos(Theta)*cos(Phi)'};...
                {'qbar par rho Va expr -qbar+rho*Va^2/2'};...
                {'Fax qbar par S Cx ni Cxq par c q ni Va ni Cxde de expr -Fax+qbar*S*(Cx+Cxq*c*q/2/Va+Cxde*de)'};...
                ...
                {'Cxq par CDq ni par CLq aoa expr -Cxq-CDq*cos(aoa)+CLq*sin(aoa)'};...
