    ...
    methods
        function this = g041()
            ...
            dyn = [...
                ...
                {'Fay p r beta da dr ni Va qbar Cy0 ni Cyb ni Cyp ni Cyr ni Cyda ni Cydr par b par S expr -Fay+qbar*S*(Cy0+Cyb*beta+Cyp*b*p/2/Va+Cyr*b*r/2/Va+Cyda*da+Cyr*dr)'};...
                ...
                {'L ni qbar par S par b Cp0 ni Cpb beta ni Cpp par b p ni Va ni Cpr r ni Cpda da Cpdr dr expr -L+qbar*S*b(Cp0+Cpb*beta+Cpp*b*p/2/Va+Cpr*b*r/2/Va+Cpda*da+Cpdr*dr)'};...
                ...
                {'N ni qbar par S par b Cr0 ni Crb beta ni Crp b ni Va ni Crr r ni Crda da ni Crdr dr expr -N+qbar*S*b*(Cr0+Crb*beta+Crp*b*p/2/Va+Crr*b*r/2/Va+Crda*da+Crdr*dr)'};...
            ...
            msr = [...
                {'dt inp dtc expr equal'};...
                {'da inp dac expr equal'};...
                {'de inp dec expr equal'};...
                {'dr inp drc expr equal'};...
                {'Va msr Vam expr equal'};...
                {'p msr pm expr equal'};...
                {'q msr qm expr equal'};...
                {'r msr rm expr equal'};...
                {'phi msr phim expr equal'};...
                {'theta msr thetam expr equal'};...
                {'psi msr psim expr equal'};...
                ];
