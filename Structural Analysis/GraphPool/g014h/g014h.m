classdef g014h < model
    ...
    methods
        function this = g014h()
            ...
            % Angular Velocity
            kin = [kin;...
                {'C_0 ni p ni q ni r par J_6 par J_7 par J_8 par J_3 par J_4 par J_5 sub kinematics expr -C_0+q*(J_6*p+J_7*q+J_8*r)-r*(J_3*p+J_4*q+J_5*r)'};...
                {'C_1 ni p ni q ni r par J_0 par J_1 par J_2 par J_6 par J_7 par J_8 sub kinematics expr -C_1+r*(J_0*p+J_1*q+J_2*r)-p*(J_6*p+J_7*q+J_8*r)'};...
                {'C_2 ni p ni q ni r par J_3 par J_4 par J_5 par J_0 par J_1 par J_2 sub kinematics expr -C_2+p*(J_3*p+J_4*q+J_5*r)-q*(J_0*p+J_1*q+J_2*r)'};...
...
%                 {'T_atot_z T_a_z sub aerodynamics'};...
                ...
                {'C_D ni V_a ni alpha ni q ni delta_e par C_D_O par C_D_alpha par C_D_q par C_D_delta_e sub aerodynamics expr -C_D+C_D_0+C_D_alpha*alpha+C_D_q*c*0.5/V_a*q+C_D_delta_e*delta_e'};...
...
%                 {'fault V_mot V_bat I_mot ni delta_t sub motor'};...
            ...
            mod = [mod;...
                ...
                {'P P_0 ni T_0 ni T par M_0 par R_star par g_0sub athmosphere expr -P+P_0*pow(T_0/T,g_0*M_0/R_star/L_0)'};... % Pressure gradient
