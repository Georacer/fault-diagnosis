...
addpath(genpath('LLGraph'));
addpath(genpath('LLMatcher'));
addpath(genpath('LLModelCreator'));
addpath(genpath('LLPlotter'));
addpath(genpath('LLResidualGenerator'));
addpath(genpath('LLSubgraphGenerator'));