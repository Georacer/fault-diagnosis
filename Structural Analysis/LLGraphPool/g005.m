function [ constraints, coords ] = g005( )
...
dyn = [...
    {'Fx V a inp de theta inp Xt'};...
    {'Fy V b p r inp da inp dr theta phi'};...
    {'Fz V a q inp de theta phi'};...
    {'L V b r inp da inp dr'};...
    {'M V a q inp de'};...
    {'N V b p r inp da inp dr'};...
    {'V u a b'};...
    {'V v a'};...
    {'V w a b'};...
    ];
