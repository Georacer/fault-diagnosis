...
%         debug = false;
    ...
    methods
        ...
        [ expr ] = getStrExprByAlias( gh, alias )
        [A, varIds, eqInd, varInd] = getSubmodel(gh, eqIds, varargin)
        ...
        plotG4M(this)        
        plotDot(this,graphName,compile)
        plotSparse(this)
        s = printEdges(gh,ids)
        plotDM(gh)
        plotMatching(this)
        ...
        M = matchWeightedElimination(gh, varargin)
